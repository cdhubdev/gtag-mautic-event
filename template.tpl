...

{
  ...
  "description": "Add page view or custom events in Candidate Hub. Recommended to be used to trigger additional events, after initialization of  Candidate Hub tracking (see Candidate Hub with consent tag)",
  "containerContexts": [
    "WEB"
  ]
}
